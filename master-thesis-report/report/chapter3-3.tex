...
\begin{table}[h]
  \begin{tabular}{llll}
  Method                                      & Scheme          & C1 - Time (seconds)  & C2 - Time (seconds)  \\ \hline
  IBE PKG Keypair generation                  & Waters09        & 0.09965              & 0.02709              \\ %\hline
  IBE Encrypting CEK                          & Waters09        & 0.05265              & 0.18915              \\ %\hline
  IBE Private Key (PK) generation             & Waters09        & 0.05614              & 0.01786              \\ %\hline
  Encrypting PK                               & AES             & 0.00013              & 0.00010              \\ %\hline
  IBS PKG Keypair generation                  & Waters          & 0.09755              & 0.02715              \\ %\hline
  IBS Private Key (SPK) generation            & Waters          & 0.00976              & 0.00287              \\ %\hline
  IBS Sign                                    & Waters          & 0.00990              & 0.00288              \\ %\hline
  IBS Verify                                  & Waters          & 0.00758              & 0.00266              \\ %\hline
  Encrypting SPK                              & AES             & 0.00006              & 0.00002              \\ %\hline
...
\begin{table}[h]
  \begin{tabular}{lll}
  Protocol                                & C1 - Time (seconds)   & C1 - Time (seconds)     \\ \hline
