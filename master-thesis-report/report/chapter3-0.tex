...
One of the benefits is that one can distribute lots of data, to many people. 
In this case, synchronization of file(s) to a large group of nodes. 
...
Lets say there is a list owner, e.g. a \gls{TTP}. 
...
Each node in a ChronoSync application broadcasts its sync state in a Sync Interest (e.g. \path{/ndn/sync/fileSyncFolder/<username>/<state>}).
