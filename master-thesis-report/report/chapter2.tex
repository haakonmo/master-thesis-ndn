...
Explain the difference in secure data and a secure channel.
...
This type of network is called \gls{CDN}.  
...
Skipping all the trust based in mapping of hosts, where the data comes from, and securing the channel.
The content should be mapped to the authors Name and this mapping should be signed by the author. 
The concept is to mathematically prove that the content originates from the believed author, and that its not modified nor been exposed to unauthorized eyes.
