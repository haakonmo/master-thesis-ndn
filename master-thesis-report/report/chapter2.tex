...
Doing a triple mapping the Name (N) and content (C), cryptographically signed by the publisher (P)~\autoref{eq:mapping_name-content}.
This mapping is unique relying on the hash computation done in the signing, and provide validity, provenance and relevance.
...
A clear benefit is that the Name can be of any form. 
