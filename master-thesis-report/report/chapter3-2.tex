...
Since the ID\textsubscribe{device} is appended to the Interest and the Interest is signed by the corresponding SK\textsubscribe{device}, the \gls{ID} of the device can easily be authenticated. 
