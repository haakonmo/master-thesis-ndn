...
Every Interest has a timestamp attached to the Name (e.g. \path{/ndn/no/ntnu/device/name2/sensor_pull/\textbf{1429710873778}}), i.e. milliseconds from \path{UTC 1970-01-01 00:00:00}, that is used for protection against replay attack. 
