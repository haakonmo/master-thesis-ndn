...
Given that the file (\path{/ntnu/file1}) these computers are interested in is 4 gigabyte, the network saves a lot of traffic with multicast provided by \gls{NDN}.
...
\todo{addressing figure ndn vs ip}
