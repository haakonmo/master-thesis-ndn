...
\begin{table}[h]
  ...
  \end{tabular}
  \caption{Node bandwidth allocation comparison in IP and NDN (best case). Mobile, 2\textsuperscript{nd}device and 3\textsuperscript{rd}device requests \protect\path{/ntnu/file1} (4GB). The NDN nodes allocates bandwidth 44.3\% (in) and 66.3\% (out) compared to IP nodes.}
