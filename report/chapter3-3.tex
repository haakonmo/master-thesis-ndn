...
\begin{figure}[ht]
  ...
  \caption{\texttt{Init} \gls{interest} and \gls{data}}
...
\begin{figure}[ht]
  ...
  \caption{\texttt{Sensor} \gls{interest} and \gls{data}}
...
\begin{table}[h]
  ...
  IBE Encrypting CEK                          & Waters09        & 47.65 ms        & 18.91 ms    & 24.86 ms     \\ %\hline
...
\begin{figure}[ht]
  ...
  \caption{Health Sensor System implementation tested over two computer. 
