...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance=6cm,auto,>=stealth']
      ...
      \draw ($(client)!0.15!(client_ground)$) -- node[above,scale=0.8,left]{ID\textsubscript{device}, tk} ($(client)!0.15!(client_ground)$);
      \draw ($(server)!0.15!(server_ground)$) -- node[above,scale=0.8,right]{(msk, mpk), ID\textsubscript{PKG}} ($(server)!0.15!(server_ground)$);
      
      \draw[->] ($(client)!0.25!(client_ground)$) -- node[above,scale=1,midway]{ID\textsubscript{device} || tk} ($(server)!0.25!(server_ground)$);
      \draw[<-] ($(client)!0.40!(client_ground)$) -- node[above,scale=1,midway]{ID\textsubscript{PKG}} ($(server)!0.40!(server_ground)$);
      \draw ($(server)!0.50!(server_ground)$) -- node[above,scale=0.8,right]{Admin manually approves ID\textsubscript{device}} ($(server)!0.50!(server_ground)$);

      \draw[->] ($(client)!0.70!(client_ground)$) -- node[above,scale=1,midway]{Interest: Enc\textsubscript{tk}[ID\textsubscript{device} || nonce]} ($(server)!0.70!(server_ground)$);
      \draw ($(server)!0.75!(server_ground)$) -- node[above,scale=0.8,right]{c = Enc\textsubscript{tk}[sk || nonce]} ($(server)!0.75!(server_ground)$);
      \draw[<-] ($(client)!0.85!(client_ground)$) -- node[above,scale=1,midway]{Data: Sign(c || mpk)} ($(server)!0.85!(server_ground)$);
      \draw ($(client)!0.85!(client_ground)$) -- node[above,scale=0.8,left]{verify} ($(client)!0.85!(client_ground)$);
      \draw ($(client)!0.90!(client_ground)$) -- node[above,scale=0.8,left]{sk = Dec\textsubscript{tk}[c]} ($(client)!0.90!(client_ground)$);
      \draw ($(client)!0.95!(client_ground)$) -- node[above,scale=0.8,left]{mpk} ($(client)!0.95!(client_ground)$);
  \end{tikzpicture}
  \caption{Device Registration. 
  The first two messages is exchanged through e.g. NFC (\autoref{rendezvous_authentication}), and thus is protected against any adversaries listening outside the NFC signal range. 
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance=4.5cm,auto,>=stealth']
      \node[] (server) {PKG};
      \node[left = of server] (client_1) {Mobile};
      \node[left = of client_1] (client_0) {Device};
      ...
      -- node[above,scale=0.8,midway]{Interest: Sign\textsubscript{ID\textsubscript{m}}(ID\textsubscript{d} || nonce || request)} 
      ($(client_1)!0.30!(client_1_ground)$);

      \draw[<-] ($(client_0)!0.60!(client_0_ground)$) 
      -- node[above,scale=0.8,midway]{Data: Sign\textsubscript{ID\textsubscript{m}}(e\_cek || c)} 
      ($(client_1)!0.60!(client_1_ground)$);

      \draw ($(client_1)!0.35!(client_1_ground)$) 
      -- node[above,scale=0.8,right]{verify(signature, mpk, ID\textsubscript{m})} 
      ...
      -- node[above,scale=0.8,right]{e\_cek = IBEnc\textsubscript{sk\textsubscript{d}}(cek || mpk)} 
      ...
      -- node[above,scale=0.8,right]{verify(signature, mpk, ID\textsubscript{d}, sha1(e\_cek || c))} 
      ($(client_0)!0.70!(client_0_ground)$);
      \draw ($(client_0)!0.75!(client_0_ground)$) 
      -- node[above,scale=0.8,right]{cek = IBDec\textsubscript{ID\textsubscript{d}}(e\_cek || mpk)}
